...
<head>
    ...
    <title>Practical Example: HTML, CSS, PHP, Forms, Database Connectivity</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Practical Example: HTML, CSS, PHP, Forms, Database Connectivity</h1>
        
        <!-- Display Success or Error Message -->
        <?php if (!empty($success)) { echo "<div class='alert alert-success'>$success</div>"; } ?>
        <?php if (!empty($error)) { echo "<div class='alert alert-danger'>$error</div>"; } ?>

        <!-- HTML Form for collecting data -->
